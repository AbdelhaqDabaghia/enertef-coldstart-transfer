...
\addlinespace
Nightly adaptation &
Nothing---the trigger function has no resource policy and no schedule, so it
can only be invoked by hand &
Last invoked 2026-08-26; twice before that, in July. The loop the system is
built around has never run on a schedule &
